  ...
  <div class="player" v-show="playlist.length>0">
    ...
    >
      <div class="normal-player" v-show="fullScreen">
        <div class="background">
          <img :src="currentSong.imge" width="100%" height="100%">
        </div>
        <div class="top">
        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-right" :class="disbleCls">
              <i class="icon" @click="togoFavorite(currentSong)" :class="getFavoriteIcon(currentSong)"></i>
            </div>
          </div>
        </div>
      </div>
    ...
    <transition name="mini">
      <div @click="open" class="mini-player" v-show="!fullScreen">
        <div class="icon">
          <img :class="cdCls" :src="currentSong.imge" width="40" height="40">
        </div>
        <div class="text">
  ...
  export default {
    ...
    methods: {
      ...
      format(interval) {
        ...
        const second = this.pads(interval % 60)
      ...
      middleTouchMove(e) {
        ...
        const width1 = Math.min(0, Math.max(-window.innerWidth, (left + daltaX)))
        console.log(-window.innerWidth)
        console.log(left + daltaX)
        this.touch.percent = Math.abs(width1 / window.innerWidth)
        this.$refs.lyricList.$el.style[transform] = `translate3d(${width1}px, 0, 0)`
